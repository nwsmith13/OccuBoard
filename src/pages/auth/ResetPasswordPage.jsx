      ...
      <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-[#0D1B2A]/95 p-6 text-[#F8FAFC] shadow-soft">
        ...
        {updated ? (
          <div className="text-center">
            ...
            <p className="mt-3 text-sm leading-6 text-[#CBD5E1]">Your OccuBoard password has been changed successfully.</p>
            <Link to="/login" className="mt-6 inline-flex"><Button>Back to login</Button></Link>
          </div>
        ) : (
          <>
            <h1 className="text-3xl font-bold">Choose a new password</h1>
            <p className="mt-2 text-sm leading-6 text-[#CBD5E1]">Use at least six characters and choose something unique to OccuBoard.</p>
