...
export function BillingLimitModal({ open, title, body, upgrading = false, onUpgrade, onClose }) {
  if (!open) return null;
  return (
      ...
      <section className="w-full max-w-md rounded-xl bg-white p-5 shadow-soft ring-1 ring-brand-100">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <h2 id="billing-limit-title" className="mt-1 text-xl font-black text-ink">{title}</h2>
          </div>
